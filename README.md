...
The module contains the following criteria:
    ...
    2. Modification of a given user
    3. List of users (with pagination) 
    
******************************************************************************
HOW TO RUN ON PERSONAL SYSTEM
1. clone the repo to your local system,
2. Run "node install" to download the required dependencies
3. Run npm start in /dashboard to view the file.
